...
def download_pdf(book_url):
    ...
    with requests.Session() as session:
        ...
        if not data_preview:
            print("Missing data-preview attribute.")
            return None
        ...
        if not r_value:
            print("Failed to extract 'r' parameter.")
            return None
        ...
        if not download_link:
            print("Download link not found in intermediate page.")
            return None
        ...
        if pdf_response.headers.get('Content-Type') == 'application/pdf':
            ...
            print("Failed to download PDF. Check the final URL.")
            return None
